...
/* --- The demonstration video for each exercise ---------------------------
   One real, human-made video per exercise: [youtube id, title]. Attached to
   the library below so every exercise card and every step of the session
   player embeds its own explanation rather than describing one. */

const EX_VIDEO = {
  breath360: ['LKixBKyV8-Y', '360° Breathing — Diaphragm Positional Breathing'],
  pelvicTilt: ['YLaTyrPAjbw', 'Pelvic Tilt Exercise For Lower Back Pain Relief (Beginner Friendly)'],
  hipCar: ['pjLS-Cr0oII', 'Standing Hip CARs — Controlled Articular Rotations'],
  shoulderCar: ['2hyNG1U5wYs', 'How To Do Shoulder CARs — Movement Breakdown'],
  ankleCar: ['ZtVdo3Vbpf8', 'Ankle Mobility Reset — Flexes & Circles Tutorial'],
  neckCar: ['phn7PKnGnyA', 'Basic Neck Movements — Tilts, Rotations, Oscillations, Circles'],
  pressUp: ['kFZ8-rMItKk', 'How To: McKenzie Press Ups for Low Back Pain and Sciatica'],
  proneOnElbows: ['Z1IM_NDRWn4', 'Prone Press Up'],
  catCow: ['gBvCQbbNyNo', 'Cat-Cow — Spine Mobility, Exercise Tutorial for Beginners'],
  sciaticSlider: ['A42tSJ_7-CM', 'Sciatic Nerve Glide Floss in Seated Position'],
  deadBug: ['bxn9FBrt4-A', 'How to do a Dead Bug — Proper Form & Technique (NASM)'],
  birdDog: ['S1QbyYZaXIg', 'McGill Big 3 — The Bird Dog'],
  curlUpMcGill: ['_tz9WGVH25g', 'How To Correctly Perform The McGill Modified Curl Up'],
  sidePlank: ['ribtncUfriU', 'The Kneeling Side Plank — Beginner Side Plank Variation'],
  glueBridge: ['n6JiF2jp2Ns', 'How to Do the Glute Bridge Properly (Beginner Guide)'],
  figure4: ['-g0nuyTHMrI', 'Piriformis Figure 4 Stretch — Ask Doctor Jo'],
  twistSupine: ['ezyMaQEaVaI', 'How to do Supta Matsyendrasana — Supine Spinal Twist, Beginners'],
  childsPose: ['EniGBCHAEVQ', 'How to do Child\'s Pose PROPERLY — Yoga for Beginners'],
  pallof: ['ZS9m5BZnuu4', 'Half-Kneeling Dumbbell Pallof Press'],
  suitcase: ['WhxtwWqb2BQ', 'Master the Suitcase Carry — Core, Grip & Posture (Proper Form)'],
  strapHam: ['Il1L75v6gq0', 'Hamstring Stretch with a Strap, Supine — Ask Doctor Jo'],
  hipFlexorLunge: ['KiTGo4L4Bgg', 'Half Kneeling Hip Flexor Stretch with Posterior Pelvic Tilt'],
  ninetyNinety: ['HUZimFZJZWU', 'How to Do the 90/90 Switch for Hip Mobility (Step-by-Step)'],
  ninetyNinetyLean: ['0ZYqmhAbC7k', 'Hip 90/90 Stretch — Internal & External Rotation'],
  adductorRock: ['yF8o6I6aSZg', 'Adductor Quadruped Rockback — Hip Mobility Drill'],
  frogStretch: ['tAR3DWA5NFo', 'How To Do A Frog Stretch — Demonstration and Guide'],
  lowLunge: ['4O_wAn8FgiI', 'How to do Anjaneyasana, Low Lunge Tutorial for Beginners'],
  halfSplit: ['1ExbFBsAIlQ', 'Ardha Hanumanasana (Half Splits) — Beginner-Friendly Tutorial'],
  cossack: ['JaCbmoDqUc4', 'How To Cossack Squat (Beginner to Advanced)'],
  hamstringEcc: ['6pVtAm2uSvE', 'Hamstring Sliders — Eccentric Hamstring Exercise'],
  pigeonAlt: ['cJlE4gn_XNw', 'Pigeon Pose — Modifications and Variations with Props'],
  happyBaby: ['uTrk6a4uaS0', 'How to Do Happy Baby Pose (Ananda Balasana) — Beginner Yoga'],
  gluteMedSide: ['9dJVwNzbH7s', 'Side-Lying Hip Abduction for Glute Medius'],
  hipThrust: ['T55MKVmc0G0', 'Dumbbell Hip Thrust Form — How To On a Bench'],
  pilBreath: ['fbGtZqVN8HA', 'Pilates Breathing For Beginners — beginner series class 1'],
  pilImprint: ['_cDorSkB_R4', 'Pilates Imprint vs Neutral Spine — Core Stability Explained'],
  pilToeTap: ['Kb_YvqxDuFE', 'Core Stability — Pilates Essential Exercise: Toe Taps'],
  pilShoulderBridge: ['AGqohhQQ5_E', 'How to do the Shoulder Bridge (Easy Pilates Mat exercise)'],
  pilClam: ['Cigb7cbcNxs', 'Clamshell Exercise — Correct Your Form & Activate Gluteus Medius'],
  pilSwimming: ['N-aII025loc', 'Swimming Prep Exercise — Beginner Mat Pilates Tutorial'],
  pilSideKick: ['nSw9GyK9YRM', 'Pilates Side Kick Series — Beginner'],
  pilMermaid: ['jBoILMf0M2o', 'How to do the Mermaid Side Bend Pilates Exercise'],
  pilRollDownWall: ['EZgSD_Y5qBI', 'Use the wall to get your spine moving — Pilates Roll Downs'],
  pilSingleLegStretch: ['TlkVjAOaKBo', 'Single Leg Stretch Exercise — Beginner Mat Pilates Tutorial'],
  pilLegPullFront: ['rGpw_cUfIAg', 'Planks with Leg Lift — Ask Doctor Jo'],
  wallSlide: ['YIvNRUJp7_E', 'Wall Slides — Shoulder Health'],
  doorwayPec: ['0wU6V78E_lM', 'Doorway Pec Stretch in 3 Positions'],
  strapDislocate: ['riVxa9By-pM', 'How To Do Band Dislocates / Pass-Throughs (Shoulder Mobility)'],
  latStretchBlock: ['6Fc0u9xPkL8', 'The Bench Stretch — Lat and Thoracic Spine Mobility'],
  wristSeries: ['Je78jBK34UY', 'Quadruped Rocks — Different Wrist Positions'],
  scapPushup: ['fpcCIkcstyU', 'Use the scapular push up to progress serratus anterior strength'],
  proneYTW: ['WAnSCSJbQYw', 'Prone Y, T, A, W Raise on Incline Bench'],
  threadNeedle: ['JPK24P1JD6s', 'Thread the Needle (Improve Thoracic Rotation Mobility)'],
  puppyPose: ['jfxtc1V7DFg', 'How to do Puppy Pose (Uttana Shishosana) — Form, Variations, Mistakes'],
  benchRow: ['fURsHPHgssI', 'Single-Arm Dumbbell Row on a Bench — Perfect Form Tutorial'],
  inclinePress: ['awEEyL5zGvU', 'How To PROPERLY Dumbbell Incline Press — 3 Common Mistakes'],
  pullover: ['MNsTXivDjHk', 'Maximize Your Dumbbell Pullovers — Target Lats & Chest'],
  extRotation: ['3XLT7kpMzcM', 'Dumbbell Side Lying External Rotation Form Tutorial'],
  mountain: ['zVPEclLvKg0', 'Mountain Pose (Tadasana) Tutorial — Step-by-Step for Beginners'],
  catCowFlow: ['oYCy6_woyIM', 'How To Use Blocks for Sun Salutations, Beginner Yoga'],
  downDog: ['uVCbg7DdIqk', 'Downward Dog — How to Fix & Align Your Pose (Yoga With Tim)'],
  warrior1: ['IcAGektqvsc', 'Warrior 1 Tutorial — Proper alignment for Virabhadrasana I'],
  warrior2: ['-2VnWzoKJhA', 'How to Do Warrior II — Virabhadrasana II Alignment & Tips'],
  triangle: ['-Qq6hp2wb2g', 'Triangle Pose Alignment & Tips — Yoga for Beginners'],
  chairPose: ['NUTWhwm04WY', 'Chair Pose Tutorial — Alignment & Tricks for Beginners'],
  treePose: ['L2g5cq8h3as', 'Alignment Tips for Tree Pose — Vrksasana Tutorial'],
  sphinx: ['HTYD97mUo8E', 'How To: Sphinx Pose (Salamba Bhujangasana) — Tips & Modifications'],
  malasana: ['fKLJRJ9YxBo', 'Learn Malasana (Deep Squat) in 10 Minutes — Beginner Tutorial'],
  gatePose: ['_xKgCrr_n9g', 'Gate Pose (Parighasana) — Foundations of Yoga'],
  seatedTwistYoga: ['at_ohf5-5qU', 'Seated Spinal Twist (Ardha Matsyendrasana) — Pose Guide Tutorial'],
  kneeToWall: ['Y1IZXkdPPdw', 'Knee to Wall Ankle Mobility Drill'],
  calfStretchStep: ['osYF1clbyMs', 'Standing Calf Stretch — Straight and Bent Knee'],
  calfRaiseEcc: ['os7WUUvTQfY', 'How to do a Single Leg Calf Raise with slow eccentric'],
  tibRaise: ['VzIcGAgBiaM', 'Tibialis Wall Raises (Exercise Demo)'],
  footBall: ['zy69TOS6ick', 'Plantar Fasciitis Stretches — Ball Rolling'],
  toeYoga: ['Vyof9r7DNok', 'Foot Intrinsic Strengthening ("Toe Yoga")'],
  squatPry: ['BRVCC_Xnm7E', 'How to Improve Your Squat Depth and Mobility — Goblet Squat Prying'],
  stepUp: ['tqECKZxlCKE', 'Dumbbell Step-Ups — Master Proper Form (Coach Series)'],
  splitSquat: ['Ft-NS5Ogti0', 'Split Squat — Proper Form Tutorial (Beginner Friendly)'],
  openBook: ['hElN9Yj7qjk', 'Thoracic Spine Rotation (Open Book) — Upper Back Mobility'],
  rollerExt: ['uaPYcTNEw_A', 'How To Do a Thoracic Extension with Foam Roller'],
  quadrupedRotation: ['snzLuyYgbVI', 'Thoracic Rotation in Quadruped — Ask Doctor Jo'],
  sideBendStanding: ['wY9nQ-yfRwo', 'Standing Side Bend Tutorial — Proper Form and Technique'],
  chinTuck: ['RQbDQgfKhBE', 'Deep Neck Flexor Muscle Activation — Supine Chin Tuck'],
  scalene: ['2nH6bWtoYl4', 'Seated Scalene Stretch with Arm Anchor'],
  ribBreathing: ['sH8Kh3xRcwo', 'Side Lying Foam Roller Breathing — Rib Cage Expansion'],
  wallAngel: ['A9TD09kzjGY', 'Common Wall Angel Mistakes — Progressions For Proper Form'],
  legsUpWall: ['xmcDj4Bf--0', 'How to do Legs Up the Wall — Viparita Karani'],
  supportedBridge: ['PEPQRwFeTEk', 'Supported Bridge Pose with Blocks — Gentle Inversion, Low Back Relief'],
  reclinedButterfly: ['FnhjJxEzsoQ', 'Restorative Yoga Basics — Reclined Bound Angle (Supta Baddha Konasana)'],
  supportedChild: ['rcdC1RWAA_4', 'Restorative Yoga — Supported Child\'s Pose'],
  savasana: ['_SaXz5OOkGw', 'Guided Savasana Body Scan — 10 Minutes'],
  gluteBall: ['Ko83NNZAymY', 'How to trigger point release your glutes & piriformis muscles'],
  rollerQuadIT: ['asgAWqwC67c', 'How To Foam Roll Your Quads'],
  diaphragmReset: ['I9wZTNaDlVo', '90-90 Breathing'],
  gobletSquat: ['9KzZD_n2r64', 'How to Goblet Squat — The Complete Guide for Beginners'],
  dbFloorPress: ['AqYFvc9t_vU', 'How To PROPERLY Dumbbell Floor Press (Fix Your Form)'],
  dbShoulderPress: ['fuQpuu--bMI', 'Seated Dumbbell Shoulder Press Guide — Form, Tips, Mistakes'],
  dbCurlAndExt: ['KCjhRJCu9m4', 'Dumbbell Curl / Overhead Triceps Extensions Superset'],
  farmerCarry: ['lLAw6fUccKA', 'Farmer\'s Carry Tutorial — Proper Form and Technique'],
  dbRDL: ['3zqDris6lD4', 'Dumbbell Romanian Deadlift — Beginner Hip Hinge & Movement Awareness'],
};

for (const id in EX_VIDEO) {
  if (EX[id]) { EX[id].vid = EX_VIDEO[id][0]; EX[id].vidT = EX_VIDEO[id][1]; }
}
